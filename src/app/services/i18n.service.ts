...
export class I18nService {
  ...
  private translations: { [key: string]: { [key: string]: string } } = {
    tr: {
      ...
      'csvExported': 'Şifreler CSV formatında dışa aktarıldı',
      'csvImported': 'CSV dosyası başarıyla içe aktarıldı',
      'csvImportError': 'CSV dosyası içe aktarılırken hata oluştu',
      'csvValidationError': 'CSV dosyası geçersiz format içeriyor',
      'csvImportConfirm': 'CSV İçe Aktarma',
      'csvImportMessage': 'Bu işlem mevcut şifrelerinizi etkileyebilir. Devam etmek istiyor musunuz?',
      'csvFileNotSelected': 'Lütfen bir CSV dosyası seçin',
      'csvInvalidFormat': 'Geçersiz CSV dosya formatı',
    ...
    en: {
      ...
      'csvExported': 'Passwords exported to CSV format',
      'csvImported': 'CSV file imported successfully',
      'csvImportError': 'Error occurred while importing CSV file',
      'csvValidationError': 'CSV file contains invalid format',
      'csvImportConfirm': 'CSV Import',
      'csvImportMessage': 'This operation may affect your existing passwords. Do you want to continue?',
      'csvFileNotSelected': 'Please select a CSV file',
      'csvInvalidFormat': 'Invalid CSV file format',
